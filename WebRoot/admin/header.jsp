...
<td rowspan="2" width="160px"><div class="logo"><a href="http://www.jsprun.net/" target="_blank"><img src="images/admincp/logo.gif" alt="JspRun!" class="logoimg" border="0"/></a> <span class="editiontext">党群工作论坛<span class="editionnumber">${settings.version}</span><br /><bean:message key="admincp"/></span></div></td>
